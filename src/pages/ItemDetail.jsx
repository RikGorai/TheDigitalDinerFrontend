...
export default function ItemDetail() {
    ...
    return (
        <div className="flex items-center justify-center px-4 py-16 min-h-screen bg-gray-900 text-white">
            <div className="p-6  min-w-[300px] max-w-[500px] bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                ...
                <p className="text-gray-400 text-center mb-4 break-words">{item.description}</p>
